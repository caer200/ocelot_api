...
1. heuristic rules 10.1039/c7tc02553j

2. finger print Hirshfield 10.1039/c1ce05763d
"""
from api.schema.dimercollection import DimerCollection
    ...
    def identify_heuristaic(self):
        ...
        for i in range(self.boneconfig.z):
            ...
            report[i] = dict(
                ...
                n_close_azm_and_notparallel = n_close_azm_and_notparallel,  # min distance between backbone proj<2, 1.5>oslip
                n_close_vertical_and_parallel = n_close_vertical_and_parallel,  # min distance between backbone proj<2, 4>oslip>1.5
