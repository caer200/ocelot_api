...
so here a summary of representing disorder in cif file
    ...
    5. disordered sites are present in the cif file but not labeled at all, e.g. ANOPEA

in case 1. it is possible to get the occupancies via CSD API, not always tho.

I cannot find a way to process 3., 4., 5. without checking deposition records or chemistry analysis, so this parser
will ignore them
